function [classifier, err_count, run_time, mistakes, mistakes_idx, SVs, TMs] = HetOTL12(Y, Kernel, P_it, text_gnd, options, id_list)
% HomOTL1: HomOTL-I
%--------------------------------------------------------------------------
% Input:
...
for t = 1:length(ID),
    ...
    f_t=w_2t*hat_f2+w_3t*hat_f3-1/2;
		%======================================
